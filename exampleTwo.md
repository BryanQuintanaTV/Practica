...
> Usuario: Bryan <br>
> Password: BryanPass <br>
> Rol: User <br>
> Hora: 13:40 <br>
> Producto: Skittles<br>
> Categoria: Dulces<br>
> Precio: 2.50<br>
...
flowchart TD
   ...
   A@{ shape: comment, label: "Error: No tiene los permisos necesarios"}
   E18 ~~~ A
   ...
   style E19 fill:#B22222
   style E20 fill:#B22222
   style E24 fill:#B22222
```
> Frontend Note: It could have a user role validation to avoid calling the API because that user 
> role (user) does not have the necessary permissions to add a new product
...
flowchart TD
    ...
    A@{ shape: comment, label: "Nombre: Skittles<br>Categoria: Dulces<br>Precio: 2.50" }
    B@{ shape: comment, label: "Nombre: Skittles" }
    D1 ~~~ B
...
flowchart TD
    ...
    A@{ shape: comment, label: "Username: Bryan<br>Password: BryanPass" }
    H1 ~~~ A
...
flowchart TD
    ...
    style A4 fill:#B22222
    style A5 fill:#B22222
    style A14 fill:#B22222
...
flowchart TD
    ...
    A@{ shape: comment, label: "Hora: 13:40"}
    B2{hora >=8 && hora <= 19}
    B3(Retornar true)
    B4(Retornar false)
...
flowchart TD
    ...
    A@{ shape: comment, label: "Rol: User"}
    C1 ~~~ A
    ...
    style C2 fill:#B22222
    style C4 fill:#B22222
    style C5 fill:#B22222
```
